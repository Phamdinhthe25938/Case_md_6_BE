...
public class EnterpriseApi {
    ...
    @PostMapping("/statusPostEnterprise")
    public ResponseEntity<PostEnterprise> statusPostEnterprise(@PathVariable boolean status) {
        return new ResponseEntity<>(postEnterpriseService.statusPost(status), HttpStatus.OK);
    }
}
